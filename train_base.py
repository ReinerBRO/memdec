...
def import_knn_components():
    from knn_utils.saveEmbedMulti import KNNSaverMulti, KNNWrapperMulti

    return KNNSaverMulti, KNNWrapperMulti
...
def main():
    ...
    if knn_args.knn:
        KNNSaverMulti, KNNWrapperMulti = import_knn_components()
