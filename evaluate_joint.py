...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=int,
        default=4,
        help="Number of worker processes for evaluation dataloaders.",
    )
    parser.add_argument(
...
def main():
    ...
    if args.with_tracking:
        ...
        tracker_name = args.project_name or "memdec_eval"
    ...
    if args.do_test:
        ...
        if args.with_tracking:
            accelerator.log(
                {
                    "eval_lm_perplexity": eval_lm,
                    "eval_joint_perplexity": eval_joint,
                    "eval_token_count": token_cnt,
                },
                step=0,
            )
